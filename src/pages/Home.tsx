      ...
      <section className="grid gap-10 md:grid-cols-2 md:items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-neutral-600">
            I&apos;m a fourth-year Mechanical Engineering and Design major at
            Northeastern University, passionate about creative ideation as
            well as 2D/3D modeling and component manufacturing. Take a look
            at my projects and background below.
          </p>
          <Link
            to="/projects"
