...
export const projects: Project[] = [
    {
        ...
        title: 'Econocorp Inc.',
        tagline:
            'Mechanical Engineer Co-op — hands-on design, prototyping, and testing.',
        summary:
        ...
        sections: [
            {
                ...
                summary:
                    'Redesigning a machine part to fix pies sliding during packaging.',
                images: [
                    {
                        src: originalPusherFaceDesign,
                        caption: 'Original Pusher Face Design',
                    },
                    {
                        src: firstIterationNewPusher,
                        caption: 'First Iteration of New Pie Pusher',
                    },
                    {
                        src: firstPrototype,
                        caption: 'First Pie Pusher Prototype',
                    },
                    {
                        src: finalPusherFaceDesigns,
                        caption: 'Final Pusher Face Designs',
                    },
                ],
                content:
    ...
    },
    {
        ...
        tagline:
            'Studio and studies exploring typography, composition, and UX.',
        summary:
    ...
    },
    {
        ...
        title: 'Computer Case',
        tagline:
            'A laser-cut laptop case for an SDG-focused engineering exhibit.',
        summary:
    ...
    },
    {
        ...
        tagline:
            'Modeling crystal structures and atomic parameters in SolidWorks.',
        summary:
